...
function TermsConditionsPolicy() {
    return (
        <>
        <main className="main">
            ...
            <div className={styles.aboutUs}>
                ...
                <p>
                    www.ondg.co.uk is operated by Ondg Ltd a company incorporated and registered in England and Wales, whose registered office is at 27 Old Gloucester Street, London, WC1N 3AX. Our Company registration number is 14153838.
                </p>

                <br />
                <h2>2. Purpose</h2>
                <p>
                Ondg objective is to allow you to order grocery items from our partners. Once you place an order, your items will be delivered to you by an Ondg courier. Access to our service and access to our site is permitted on a temporary basis, and we reserve the right to withdraw or amend access to our Site or our Service without notice (see below). We will not be liable if, for any reason, our site or our service is unavailable at any time or for any period.
                </p>
